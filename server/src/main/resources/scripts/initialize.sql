...
insert into monument_pois values (0,0,421,'Monument1','Monument1','');
insert into monument_pois values (0,0,521,'Monument2','Monument2','');
insert into monument_pois values (0,0,621,'Monument3','Monument3','');
